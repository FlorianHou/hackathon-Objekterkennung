...
def objErkennung(imgData):
    ...
    img = cv.bilateralFilter(img, -1, 45, 9)
    ...
    contourIMGVorFilter = cv.drawContours(contourIMGVorFilter, contours,-1,255,thickness=3)
    ...
    contourIMGVorFilter=np.zeros_like(gray, np.uint8)
    contourIMGVorFilter = cv.drawContours(contourIMGVorFilter, contoursRes,-1,255,thickness=3)
    ...
    contourIMGNachFilter = cv.drawContours(contourIMGVorFilter, contoursRes,-1,255,thickness=3)
